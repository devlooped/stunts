...
namespace Stunts
{
    ...
    public interface IStuntFactory
    {
        ...
        /// </summary>
        /// <param name="assembly">Assembly where compile-time generated stunts exist.</param>
        ...
        object CreateStunt(Assembly assembly, Type baseType, Type[] implementedInterfaces, object?[] constructorArguments);
    }
}
